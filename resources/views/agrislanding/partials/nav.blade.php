      ...
      <div class="col-12">
        <nav class="navbar navbar-expand-lg  blur blur-rounded top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            <a href="/"> 
                <img src="https://i.imgur.com/UMZdzVK.png"  height="40">
              </a>
                ...
                <li class="nav-item ms-lg-auto">
                  <a class="nav-link nav-link-icon me-2" href="{{ route('home')}}">
                    @auth()
                      ...
                      <p class="d-inline text-sm z-index-1 font-weight-bold">{{ __('agrislanding.dashboard') }}</p>
                    @endauth
                    @guest()
                      
                      <p class="d-inline text-sm z-index-1 font-weight-bold">{{ __('agrislanding.login') }}</p>
                    @endguest
                  </a>
                </li>
                @guest
                  <li class="nav-item my-auto ms-3 ms-lg-0">
                    <button type="button" class="btn btn-sm  bg-gradient-success  btn-round mb-0 me-1 mt-2 mt-md-0" onclick="$('#modal-register').modal('show')">
                      <span class="nav-link-inner--text">{{ __('agrislanding.register')}}</span>
                    </button>
                  </li>
                @endguest
